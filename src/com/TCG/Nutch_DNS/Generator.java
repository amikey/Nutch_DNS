...
public class Generator extends NutchTool implements Tool {
  ...
  public static final Logger LOG = LoggerFactory.getLogger(org.apache.nutch.crawl.Generator.class);
  ...
  public Path[] generate(Path dbDir, Path segments, int numLists, long topN,
    ...
    Path tempDir = new Path(getConf().get("mapred.temp.dir", ".")
        + "/generate-temp-" + UUID.randomUUID().toString());
  ...
  public static void main(String args[]) throws Exception {
    int res = ToolRunner
        .run(NutchConfiguration.create(), new org.apache.nutch.crawl.Generator(), args);
    System.exit(res);
  }
